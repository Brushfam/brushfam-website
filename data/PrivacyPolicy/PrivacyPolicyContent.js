...
export const points = [
...

  {
    ...
    point: [
      ...
      {
        text: ListText("You give us consent to do so for a specific purpose;"),
      },
      {
        text: ListText(
...

  {
    ...
    point: [
      ...
      {
        text: ListText("offer certain functionality;"),
      },
      {
        text: ListText(
          "assist Brushfam in improving our Service and creating new services features."
        ),
      },
      {
        text: (
      ...
      {
        text: ListText(
          "to protect the rights, property, or personal safety of Brushfam, our Users, or others."
        ),
      },
      {
        text: (
...

  {
    ...
    point: [
      ...
      {
        text: ListText(
          "remember Your information so that You will not have to re-enter it during Your visit or the next time You access the Brushfam Service;"
        ),
      },
      {
