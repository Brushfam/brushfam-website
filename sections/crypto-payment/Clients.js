  ...
  return (
    <section className={sectionStyles.sectionBlock}>
      ...
      <p className={styles.descriptionText}>
        Для всіх бізнесів, які бажають розширити можливості своїх інтернет-продажів, забезпечити
        зручний спосіб оплати для своїх клієнтів, а також розширити ринки та залучити додаткові
        інвестиції
      </p>
      ...
      <div className={styles.firstClients}>
        ...
        <div className={styles.twoClients}>
          <div className={styles.clientsBlock}>
            <img src={"crypto-payment/clients/service-company.svg"} />
            Сервісні компанії
          </div>
          <div className={styles.clientsBlock}>
