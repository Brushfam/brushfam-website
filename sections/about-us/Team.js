  ...
  return (
    <section className={styles.section}>
      ...
      <p className={styles.descriptionText}>
        Our team is known for its contribution to the Polkadot ecosystem. Our visionary attitude
        helps us think boldly and embrace technological challenges.
      </p>
      <div>
        <ul className={styles.teamList}>
          {teamData &&
            teamData.map((teamItem, i) => {
              return (
                <li key={i.toString()} className={styles.teamItem}>
