    ...
    <section className={styles.section}>
      ...
      <div className={styles.challengesContainer}>
        ...
        <div className={styles.challengesDiv1}>
          ...
          <p>
            Brushfam will optimize the tech performance of your team by growing
            your engineers&#39; expertise, tech vision, and ability to deliver.
          </p>
        </div>
        <div className={styles.challengesDiv2}>
          ...
          <p>
            ...
            to avoid fatal vulnerabilities and will give confidence in code
            security to business owners and users.
          </p>
        </div>
      </div>
    </section>
