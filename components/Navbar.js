            ...
            <div className={navStyles.menu}>
              ...
              <div className={navStyles.dropdown}>
                <div className={navStyles.navTitle}>
                  ...
                  >
                    <div className={navStyles.borderBlock3} style={{height: 404}}></div>
                  ...
                  <div className={navStyles.testBlock} style={{width: 294}}></div>
                </div>
              </div>

              <div className={navStyles.dropdown}>
                <div className={navStyles.navTitle}>
                  <p className={navStyles.navTitleText}>
                    Services & Solutions
                  </p>
                  <div
                      className={navStyles.dropdownContentHeader}
                  >
                    <div className={navStyles.borderBlock3} style={{height: 382}}></div>
                    <div className={navStyles.borderBlock1}></div>
                  </div>
                  ...
                  <div className={navStyles.testBlock} style={{width: 76}}></div>
                </div>
              </div>
              ...
              <div className={navStyles.dropdown}>
                <div className={navStyles.navTitle}>
                  ...
                  <div
                      className={navStyles.dropdownContentHeader}
                  >
                    <div className={navStyles.borderBlock3} style={{height: 196}}></div>
                    <div className={navStyles.borderBlock1}></div>
                  </div>
                  ...
                  <div className={navStyles.testBlock} style={{width: 172}}></div>
                </div>
              </div>
              ...
              <div className={navStyles.dropdown}>
                <div className={navStyles.navTitle}>
                  ...
                  <div
                      className={navStyles.dropdownContentHeader}
                  >
                    <div className={navStyles.borderBlock3} style={{height: 186}}></div>
                    <div className={navStyles.borderBlock1}></div>
                  </div>
                  ...
                  <div className={navStyles.testBlock} style={{width: 253}}></div>
                </div>
              </div>
